                        ...
                        <div class="x_content">
                            ...
                            <form id="form" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="hidden" id="id_ciudad" required="required" class="form-control" name="id_ciudad">
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-dismiss="modal" id="eliminar_ciudad">Si</button>
                        </div>
                    </div>
                </div>
            </div>
